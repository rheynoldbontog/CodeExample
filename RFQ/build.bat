...
%windir%\Microsoft.NET\Framework\v4.0.30319\MSBuild.exe ssg.proj /p:DebugSymbols=false /p:DebugType=None /maxcpucount /l:FileLogger,Microsoft.Build.Engine;logfile=log.log %*