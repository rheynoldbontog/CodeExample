...
namespace SSG.Core.Plugins
{
    ...
    public class PluginManager
    {
            ...
            using (new WriteLockDisposable(Locker))
            {
                ...
                try
                {
                    ...
                    foreach (var dfd in GetDescriptionFilesAndDescriptors(pluginFolder))
                    {
                        ...
                        if (!pluginDescriptor.SupportedVersions.Contains(SSGVersion.CurrentVersion, StringComparer.InvariantCultureIgnoreCase))
                        {
        ...
        private static IEnumerable<KeyValuePair<FileInfo, PluginDescriptor>> GetDescriptionFilesAndDescriptors(DirectoryInfo pluginFolder)
        {
            ...
            //it's required: http://www.SSGTemplate.com/boards/t/17455/load-plugins-based-on-their-displayorder-on-startup.aspx
        ...
        private static FileInfo InitializeMediumTrust(FileInfo plug, DirectoryInfo shadowCopyPlugFolder)
        {
            ...
            if (shadowCopiedPlug.Exists)
            {
                ...
                else
                {
                    ...
                    //More info: http://www.SSGTemplate.com/boards/t/11511/access-error-ssgplugindiscountrulesbillingcountrydll.aspx?p=4#60838
