...
namespace SSG.Services.Forums
{
    ...
    {
        #region Constants
        private const string FORUMGROUP_ALL_KEY = "SSG.forumgroup.all";
        private const string FORUMGROUP_BY_ID_KEY = "SSG.forumgroup.id-{0}";
        private const string FORUM_ALLBYFORUMGROUPID_KEY = "SSG.forum.allbyforumgroupid-{0}";
        private const string FORUM_BY_ID_KEY = "SSG.forum.id-{0}";
        private const string FORUMGROUP_PATTERN_KEY = "SSG.forumgroup.";
        private const string FORUM_PATTERN_KEY = "SSG.forum.";
        #endregion
        ...
        public virtual IPagedList<ForumPost> GetAllPosts(int forumTopicId, int userId,
        ...
        public virtual void InsertPrivateMessage(PrivateMessage privateMessage)
        {
            ...
            if (userTo == null)
            {
                throw new SSGException("Recipient could not be loaded");
            }
        ...
        public virtual IPagedList<ForumSubscription> GetAllSubscriptions(int userId, int forumId,
