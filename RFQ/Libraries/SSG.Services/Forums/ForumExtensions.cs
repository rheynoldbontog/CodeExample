...
namespace SSG.Services.Forums
{
    public static class ForumExtensions
    {
        ...
        public static string FormatForumSignatureText(this string text)
        {
            ...
            text = SSG.Core.Html.HtmlHelper.FormatText(text, false, true, false, false, false, false);
            return text;
        }
        ...
        public static string FormatPrivateMessageText(this PrivateMessage pm)
        {
            ...
            text = SSG.Core.Html.HtmlHelper.FormatText(text, false, true, false, true, false, false);
