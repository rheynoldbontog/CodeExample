...
namespace SSG.Services.Messages
{
    public partial class MessageTemplateService: IMessageTemplateService
    {
        ...
        private const string MESSAGETEMPLATES_ALL_KEY = "SSG.messagetemplate.all";
        private const string MESSAGETEMPLATES_BY_ID_KEY = "SSG.messagetemplate.id-{0}";
        private const string MESSAGETEMPLATES_BY_NAME_KEY = "SSG.messagetemplate.name-{0}";
        private const string MESSAGETEMPLATES_PATTERN_KEY = "SSG.messagetemplate.";
