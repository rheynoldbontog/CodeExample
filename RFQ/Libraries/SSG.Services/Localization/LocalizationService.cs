...
namespace SSG.Services.Localization
{
    ...
    {
        #region Constants
        private const string LOCALSTRINGRESOURCES_ALL_KEY = "SSG.lsr.all-{0}";
        private const string LOCALSTRINGRESOURCES_BY_RESOURCENAME_KEY = "SSG.lsr.{0}-{1}";
        private const string LOCALSTRINGRESOURCES_PATTERN_KEY = "SSG.lsr.";
        #endregion
