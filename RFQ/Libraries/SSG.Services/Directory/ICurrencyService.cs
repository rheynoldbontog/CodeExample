...
namespace SSG.Services.Directory
{
    ...
    public partial interface ICurrencyService
    {
        ...
        /// <param name="sourceCurrencyCode">Source currency code</param>
        /// <returns>Converted value</returns>
        decimal ConvertToPrimarySiteCurrency(decimal amount, Currency sourceCurrencyCode);
        ...
        /// <param name="targetCurrencyCode">Target currency code</param>
        /// <returns>Converted value</returns>
        decimal ConvertFromPrimarySiteCurrency(decimal amount, Currency targetCurrencyCode);
