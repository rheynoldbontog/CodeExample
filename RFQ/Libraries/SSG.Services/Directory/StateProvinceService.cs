...
namespace SSG.Services.Directory
{
    ...
    {
        #region Constants
        private const string STATEPROVINCES_ALL_KEY = "SSG.stateprovince.all-{0}";
        private const string STATEPROVINCES_BY_ID_KEY = "SSG.stateprovince.id-{0}";
        private const string STATEPROVINCES_PATTERN_KEY = "SSG.stateprovince.";
        #endregion
