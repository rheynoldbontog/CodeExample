...
namespace SSG.Data.Mapping.RFQ
{
    public class QuotationMap : EntityTypeConfiguration<SSG.Core.Domain.RFQ.Quotation>
    {
        public QuotationMap()
        {
            ...
            this.Property(t => t.QuoteValidity).IsOptional().HasMaxLength(100).HasColumnName("QuoteValidity");
            this.Property(t => t.MakerPN).IsOptional().HasMaxLength(50).HasColumnName("MakerPN");
            this.Property(t => t.UnitPrice).HasPrecision(18, 2).IsRequired().HasColumnName("UnitPrice");
            this.Property(t => t.DiscountedPrice).HasPrecision(18, 2).IsOptional().HasColumnName("DiscountedPrice");
            ...
            this.HasMany(t => t.QuoteAttachment).WithOptional().WillCascadeOnDelete(false);
            this.HasMany(t => t.ROHSDocumentAttachment).WithOptional().WillCascadeOnDelete(false);
            this.HasMany(t => t.MSDSDocumentAttachment).WithOptional().WillCascadeOnDelete(false);
