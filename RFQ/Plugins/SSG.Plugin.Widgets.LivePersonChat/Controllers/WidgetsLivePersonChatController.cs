...
using SSG.Plugin.Widgets.LivePersonChat.Models;
using SSG.Services.Configuration;
using SSG.Web.Framework.Controllers;

namespace SSG.Plugin.Widgets.LivePersonChat.Controllers
{
    public class WidgetsLivePersonChatController : Controller
    {
        ...
        public ActionResult Configure()
        {
            ...
            return View("SSG.Plugin.Widgets.LivePersonChat.Views.WidgetsLivePersonChat.Configure", model);
        }
        ...
        public ActionResult PublicInfo(string widgetZone)
        {
            ...
            return View("SSG.Plugin.Widgets.LivePersonChat.Views.WidgetsLivePersonChat.PublicInfo", model);
        }
    }
}