...
using SSG.Plugin.Feed.Become.Models;
...
namespace SSG.Plugin.Feed.Become.Controllers
{
    [AdminAuthorize]
    public class FeedBecomeController : Controller
    {
        ...
        public ActionResult Configure()
        {
            ...
            return View("SSG.Plugin.Feed.Become.Views.FeedBecome.Configure", model);
        }
        ...
        public ActionResult GenerateFeed(FeedBecomeModel model)
        {
            ...
            try
            {
                ...
                string clickhereStr = string.Format("<a href=\"{0}content/files/exportimport/{1}\" target=\"_blank\">{2}</a>", _webHelper.GetSiteLocation(false), fileName, _localizationService.GetResource("Plugins.Feed.Become.ClickHere"));
