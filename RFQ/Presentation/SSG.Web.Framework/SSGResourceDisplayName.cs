...
{
    public class SSGResourceDisplayName : System.ComponentModel.DisplayNameAttribute, IModelAttribute
    {
        private string _resourceValue = string.Empty;
        //private bool _resourceValueRetrived;

        public SSGResourceDisplayName(string resourceKey)
            : base(resourceKey)
        {
        ...
        public string Name
        {
            get { return "SSGResourceDisplayName"; }
        }
    }
}
