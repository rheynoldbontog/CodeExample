...
namespace SSG.Web.Framework.Security
{
    [AttributeUsage(AttributeTargets.Class | AttributeTargets.Method, Inherited = true, AllowMultiple = false)]
    public class SSGHttpsRequirementAttribute : FilterAttribute, IAuthorizationFilter
    {
        public SSGHttpsRequirementAttribute(SslRequirement sslRequirement)
        {
        ...
        public virtual void OnAuthorization(AuthorizationContext filterContext)
        {
            ...
            switch (this.SslRequirement)
            {
                ...
                case SslRequirement.NoMatter:
                    ...
                    break;
                default:
                    throw new SSGException("Not supported SslProtected parameter");
            }
        }
