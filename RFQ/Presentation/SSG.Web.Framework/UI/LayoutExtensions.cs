...
namespace SSG.Web.Framework.UI
{
    public static class LayoutExtensions
    {
        ...
        public static MvcHtmlString SSGTitle(this HtmlHelper html, bool addDefaultTitle, params string[] parts)
        {
            var pageTitleBuilder = EngineContext.Current.Resolve<IPageTitleBuilder>();
        ...
        public static MvcHtmlString SSGMetaDescription(this HtmlHelper html, params string[] parts)
        {
            var pageTitleBuilder = EngineContext.Current.Resolve<IPageTitleBuilder>();
        ...
        public static MvcHtmlString SSGMetaKeywords(this HtmlHelper html, params string[] parts)
        {
            var pageTitleBuilder = EngineContext.Current.Resolve<IPageTitleBuilder>();
        ...
        public static MvcHtmlString SSGScripts(this HtmlHelper html,  params string[] parts)
        {
            return SSGScripts(html, ResourceLocation.Head, parts);
        }
        public static MvcHtmlString SSGScripts(this HtmlHelper html, ResourceLocation location, params string[] parts)
        {
            var pageTitleBuilder = EngineContext.Current.Resolve<IPageTitleBuilder>();
        ...
        public static MvcHtmlString SSGCssFiles(this HtmlHelper html, params string[] parts)
        {
            return SSGCssFiles(html, ResourceLocation.Head, parts);
        }
        public static MvcHtmlString SSGCssFiles(this HtmlHelper html, ResourceLocation location, params string[] parts)
        {
            var pageTitleBuilder = EngineContext.Current.Resolve<IPageTitleBuilder>();
        ...
        public static MvcHtmlString SSGCanonicalUrls(this HtmlHelper html, params string[] parts)
        {
            var pageTitleBuilder = EngineContext.Current.Resolve<IPageTitleBuilder>();
