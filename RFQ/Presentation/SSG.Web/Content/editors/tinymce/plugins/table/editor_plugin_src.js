...
(function(tinymce) {
	...
	function TableGrid(table, dom, selection) {
		...
		function cleanup() {
			...
			// Resite selection to start position if it still exists
			buildGrid();

			// Resite the selection to the closest table position
		...
		function merge(cell, cols, rows) {
			...
			if (startCell && endCell && startCell.part == endCell.part) {
				...
				// Remove empty rows etc and resite caret location
				cleanup();
			}
		};
	...
	tinymce.create('tinymce.plugins.TablePlugin', {
		init : function(ed, url) {
			...
			function cleanup() {
				// Resite selection possibilities
