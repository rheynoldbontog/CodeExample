    ...
    if (GetNodeValue(node)) {
        ...
        $.post("_GetImages", { path: GetNodeValue(node) }, function (result) {
            ...
            if ($(result).size() > 0) {
                ...
                $('#directory img').attr('src', ssg_site_directory_root + 'Content/editors/tinymce/plugins/netadvimage/img/folder-horizontal.gif');
                $(node).closest('.t-item').find('img:first').attr('src', ssg_site_directory_root + 'Content/editors/tinymce/plugins/netadvimage/img/folder-horizontal-open.gif');
...
function HideOverlays() {
    //modified by SSGTemplate team (IE8 fix)
    ...
    init: function (ed) {
        ...
        var f = document.forms['mce'],
                ...
                uploader = new qq.FileUploader({
                    ...
                    action: ssg_site_directory_root + 'Content/editors/tinymce/plugins/netadvimage/index',
                    params: {
                        path: null
                    },
