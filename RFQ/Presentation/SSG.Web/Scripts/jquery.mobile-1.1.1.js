...
( function( $, undefined ) {
	...
	var $window = $( window ),
		...
		urlHistory = {
			// Array of pages that are vistored during a single page load.
...
( function( $, window ) {
	...
	$.extend( pushStateHandler, {
		...
		onHashChange: function( e ) {
			...
			// replace the current url with the new href and site the state
...
( function( $, window, undefined ) {
	...
	$.extend($.mobile, {
		...
		initializePage: function() {
			...
			// define first page in dom case one backs out to the directory root (not always the first page vistored, but defined as fallback)
