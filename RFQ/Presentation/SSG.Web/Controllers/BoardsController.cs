...
namespace SSG.Web.Controllers
{
    ...
    public partial class BoardsController : BaseSSGController
    {
        #region Fields
        ...
        public virtual ActionResult ActiveDiscussions(int forumId = 0)
        {
            if (!_forumSettings.ForumsEnabled)
            {
                return RedirectToRoute("HomePage");
        ...
        public virtual ActionResult ActiveDiscussionsRss(int forumId = 0)
        {
            ...
            var feed = new SyndicationFeed(
                                    string.Format(feedTitle, _siteInformationSettings.SiteName),
                                    feedDescription,
                                    new Uri(url),
        ...
        public virtual ActionResult ForumRss(int id)
        {
            ...
            if (forum != null)
            {
                ...
                var feed = new SyndicationFeed(
                                        string.Format(feedTitle, _siteInformationSettings.SiteName, forum.Name),
                                        feedDescription,
                                        new Uri(url),
            ...
            string within, string limitDays, int page = 1)
        {
            ...
            try
            {
                if (String.IsNullOrWhiteSpace(searchterms) == false)
                {
                    ...
                    {
                        throw new SSGException(string.Format(_localizationService.GetResource("Forum.SearchTermMinimumLengthIsNCharacters"),
