...
namespace SSG.Web.Controllers
{
    ...
    public partial class T4MVC_UserController : SSG.Web.Controllers.UserController
    {
        ...
        [NonAction]
        partial void RemoteLoginOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, int userId, string returnUrl);

        [NonAction]
        public override System.Web.Mvc.ActionResult RemoteLogin(int userId, string returnUrl)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.RemoteLogin);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "userId", userId);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "returnUrl", returnUrl);
            RemoteLoginOverride(callInfo, userId, returnUrl);
            return callInfo;
        }
