...
namespace SSG.Admin.Controllers
{
    ...
    public partial class NewsController : BaseSSGController
	{
        ...
        public NewsController(INewsService newsService, ILanguageService languageService,
            IDateTimeHelper dateTimeHelper, IUserContentService userContentService,
        ...
        public ActionResult Comments(int? filterByNewsItemId, GridCommand command)
        {
            ...
            else
            {
                ...
                comments = _userContentService.GetAllUserContent<NewsComment>(0, null);
            }
            ...
            var gridModel = new GridModel<NewsCommentModel>
            {
                Data = comments.PagedForCommand(command).Select(newsComment =>
                {
                    ...
                    commentModel.UserId = newsComment.UserId;
        ...
        public ActionResult CommentDelete(int? filterByNewsItemId, int id, GridCommand command)
        {
            ...
            var comment = _userContentService.GetUserContentById(id) as NewsComment;
            if (comment == null)
