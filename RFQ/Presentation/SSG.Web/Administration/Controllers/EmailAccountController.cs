...
{
	[AdminAuthorize]
	public partial class EmailAccountController : BaseSSGController
	{
        ...
        public ActionResult SendTestEmail(EmailAccountModel model)
        {
            ...
            try
            {
                if (String.IsNullOrWhiteSpace(model.SendTestEmailTo))
                    throw new SSGException("Enter test email address");


                var from = new MailAddress(emailAccount.Email, emailAccount.DisplayName);
                var to = new MailAddress(model.SendTestEmailTo);
                string subject = _siteSettings.SiteName + ". Testing email functionality.";
