    ...
    public class AutoMapperStartupTask : IStartupTask
    {
        public void Execute()
        {
            ...
            Mapper.CreateMap<Quotation, QuotationModel>()
                .ForMember(dest => dest.IsDeleted, opts => opts.MapFrom(src => !src.Active));

            Mapper.CreateMap<Quotation, Quotation>();

            Mapper.CreateMap<RFQLineModel, RFQLine>();

            Mapper.CreateMap<RFQLine, RFQLine>();
            Mapper.CreateMap<RFQLine, RFQLineModel>()
                .ForMember(dest => dest.RFQNo, opts => opts.MapFrom(src => src.RFQ.RFQNo))
                .ForMember(dest => dest.RFQCreationDate, opts => opts.MapFrom(src => src.RFQ.DateCreatedOnUtc))
                ...
                .ForMember(dest => dest.RFQCreationDate, opts => opts.MapFrom(src => src.RFQ.DateCreatedOnUtc))
                .ForMember(dest => dest.RFQStatus, opts => opts.MapFrom(src => src.RFQ.RFQStatus.Name));
            ...
            Mapper.CreateMap<RFQ, ReassignBuyerModel>()
                .ForMember(dest => dest.RFQId, opts => opts.MapFrom(src => src.Id))
                .ForMember(dest => dest.BuyerId, opts => opts.MapFrom(src => src.BuyerId))
                .ForMember(dest => dest.Buyer, opts => opts.MapFrom(src => src.Buyer.GetFullName()));

            Mapper.CreateMap<RFQ, RFQ>();
            ...
            Mapper.CreateMap<FileAttachment, FileAttachmentModel>()
                .ForMember(dest => dest.IsDeleted, opts => opts.MapFrom(src => !src.Active));
            Mapper.CreateMap<FileAttachment, FileAttachment>();
