...
namespace SSG.Plugin.Widgets.LivePersonChat
{
    ...
    public class LivePersonChatPlugin : BasePlugin, IWidgetPlugin
    {
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            routeValues = new RouteValueDictionary() { { "Namespaces", "SSG.Plugin.Widgets.LivePersonChat.Controllers" }, { "area", null } };
        }
        ...
        public void GetDisplayWidgetRoute(string widgetZone, out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            {
                {"Namespaces", "SSG.Plugin.Widgets.LivePersonChat.Controllers"},
                {"area", null},
