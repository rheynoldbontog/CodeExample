...
namespace SSG.Services.Media
{
    ...
    public partial class PictureService : IPictureService
    {
        ...
        public virtual string GetPictureSeName(string name)
        {
            ...
            //string okChars = "abcdefghijklmssgqrstuvwxyz1234567890 _-";
        ...
        public virtual string GetDefaultPictureUrl(int targetSize = 0, PictureType defaultPictureType = PictureType.Entity, bool? useSsl = null)
        {
            ...
            switch (defaultPictureType)
            {
                ...
                case PictureType.Avatar:
                    defaultImageName = _settingService.GetSettingByKey("Media.User.DefaultAvatarImageName", "defaultAvatar.jpg");
                    break;
                default:
                    defaultImageName = _settingService.GetSettingByKey("Media.DefaultImageName", "noDefaultImage.gif");
                    break;
            ...
            string relPath = (useSsl.HasValue
                                 ? _webHelper.GetSiteLocation(useSsl.Value)
        ...
        {
            return LoadPictureBinary(picture, this.SiteInDb);
        }
        ...
        public virtual Picture InsertPicture(byte[] pictureBinary, string mimeType, string seoFilename, bool isNew)
        {
            ...
            picture.PictureBinary = (this.SiteInDb ? pictureBinary : new byte[0]);
        ...
        public virtual bool SiteInDb
        {
            get
            {
                return _settingService.GetSettingByKey<bool>("Media.Images.SiteInDB", true);
            }
            set
            {
                ...
                if (this.SiteInDb != value)
                {
                    ...
                    _settingService.SetSetting<bool>("Media.Images.SiteInDB", value);
