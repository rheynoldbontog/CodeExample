...
namespace SSG.Services.Logging
{
    /// <summary>
    ...
    {
        #region Constants
        private const string ACTIVITYTYPE_ALL_KEY = "SSG.activitytype.all";
        private const string ACTIVITYTYPE_BY_ID_KEY = "SSG.activitytype.id-{0}";
        private const string ACTIVITYTYPE_PATTERN_KEY = "SSG.activitytype.";
        #endregion
