...
namespace SSG.Services.Directory
{
    ...
    {
        #region Constants
        private const string COUNTRIES_ALL_KEY = "SSG.country.all-{0}";
        private const string COUNTRIES_BILLING_KEY = "SSG.country.billing-{0}";
        private const string COUNTRIES_SHIPPING_KEY = "SSG.country.shipping-{0}";
        private const string COUNTRIES_BY_ID_KEY = "SSG.country.id-{0}";
        private const string COUNTRIES_PATTERN_KEY = "SSG.country.";
        #endregion
