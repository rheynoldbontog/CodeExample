...
using SSG.Plugin.Misc.MailChimp.Models;
...
namespace SSG.Plugin.Misc.MailChimp.Controllers
{
    [AdminAuthorize]
    public class SettingsController : Controller
    {
        private const string VIEW_PATH = "SSG.Plugin.Misc.MailChimp.Views.Settings.Index";
        ...
        {
            return _scheduleTaskService.GetTaskByType("SSG.Plugin.Misc.MailChimp.MailChimpSynchronizationTask, SSG.Plugin.Misc.MailChimp");
        }
