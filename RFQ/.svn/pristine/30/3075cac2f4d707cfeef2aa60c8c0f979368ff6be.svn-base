...
{
	[AdminAuthorize]
	public partial class CampaignController : BaseSSGController
	{
        ...
        public ActionResult SendTestEmail(CampaignModel model)
        {
            ...
            try
            {
                ...
                if (emailAccount == null)
                    throw new SSGException("Email account could not be loaded");
                ...
                SuccessNotification(_localizationService.GetResource("Admin.Promotions.Campaigns.TestEmailSentToUsers"), false);
                return View(model);
            }
            catch (Exception exc)
            {
        ...
        public ActionResult SendMassEmail(CampaignModel model)
        {
            ...
            try
            {
                ...
                SuccessNotification(string.Format(_localizationService.GetResource("Admin.Promotions.Campaigns.MassEmailSentToUsers"), totalEmailsSent), false);
                return View(model);
            }
            catch (Exception exc)
            {
