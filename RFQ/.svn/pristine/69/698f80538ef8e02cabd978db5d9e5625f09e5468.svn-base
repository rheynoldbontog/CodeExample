...
{
    /// <summary>
    /// A class that finds types needed by SSG by looping assemblies in the 
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        /// <summary>Gets or sets wether SSG should iterate assemblies in the app domain when loading SSG types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// <remarks>If you change this so that SSG assemblies arn't investigated (e.g. by not including something like "^SSG|..." you may break core functionality.</remarks>
        ...
        /// <returns>A list of assemblies that should be loaded by the SSG factory.</returns>
        ...
        /// <returns>True if the assembly should be loaded into SSG.</returns>
