    ...
    public class FileAttachmentService : IFileAttachmentService
    {
        ...
        public IEnumerable<FileAttachment> GetAllFileAttachmentsEnumerableForRFQLine(int rfqLineId, bool activeOnly = false)
        {
            return this._fileAttachmentRepository.Table
                .Where(s => (activeOnly ? s.Active : 1 == 1) && s.FileAttachmentType == (int)FileAttachmentType.RFQLineAttachment && s.Id == rfqLineId)
                .AsEnumerable();
        }
        ...
        {
            return _fileAttachmentRepository.GetById(id);
        }
