...
using SSG.Plugin.SMS.Clickatell.Clickatell;
...
namespace SSG.Plugin.SMS.Clickatell
{
    ...
    public class ClickatellSmsProvider : BasePlugin, IMiscPlugin
    {
        ...
        public bool SendSms(string text)
        {
            try
            {
                using (var svc = new PushServerWSPortTypeClient(new BasicHttpBinding(), new EndpointAddress("http://api.clickatell.com/soap/webservice_vs.php")))
                {
                    ...
                    {
                        throw new SSGException(authRsp);
                    }
                    ...
                    {
                        throw new SSGException(sndRsp[0]);
                    }
                    return true;
                }
            }
        ...
        public void GetConfigurationRoute(out string actionName, out string controllerName, out RouteValueDictionary routeValues)
        {
            ...
            routeValues = new RouteValueDictionary() { { "Namespaces", "SSG.Plugin.SMS.Clickatell.Controllers" }, { "area", null } };
        }
