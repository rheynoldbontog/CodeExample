...
using SSG.Core;
using SSG.Data.Mapping.Localization;
...
namespace SSG.Data
{
    ...
    /// Object context
    /// </summary>
    public class SSGObjectContext : DbContext, IDbContext
    {
        public SSGObjectContext(string nameOrConnectionString)
        ...
        public IList<TEntity> ExecuteStoredProcedureList<TEntity>(string commandText, params object[] parameters) where TEntity : BaseEntity, new()
        {
            ...
            if (!hasOutputParameters)
            {
                ...
                //var result = context.ExecuteSiteQuery<TEntity>(commandText, parameters).ToList();
