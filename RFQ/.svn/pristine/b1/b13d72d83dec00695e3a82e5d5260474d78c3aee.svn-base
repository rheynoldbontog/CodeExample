...
using SSG.Core.Html.CodeFormatter;

namespace SSG.Core.Html
{
    /// <summary>
    ...
    public partial class BBCodeHelper
    {
            ...
            bool replaceUnderline, bool replaceUrl, bool replaceCode, bool replaceQuote)
        {
            ...
            if (replaceUrl)
            {
                // format the url tags: [url=http://www.SSGTemplate.com]my site[/url]
                // becomes: <a href="http://www.SSGTemplate.com">my site</a>
                text = regexUrl1.Replace(text, "<a href=\"$1\" rel=\"nofollow\">$2</a>");

                // format the url tags: [url]http://www.SSGTemplate.com[/url]
                // becomes: <a href="http://www.SSGTemplate.com">http://www.SSGTemplate.com</a>
