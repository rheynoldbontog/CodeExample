...
(function() {
	...
	function init() {
		...
		document.getElementById('vistored_color_pickcontainer').innerHTML = getColorPickerHTML('vistored_color_pick','vistored_color');
		...
		updateColor('textcolor_pick', 'textcolor');
		updateColor('bgcolor_pick', 'bgcolor');
		updateColor('vistored_color_pick', 'vistored_color');
